         ...
         <button type="submit" onclick="window.location.href='bill1.php';" class="none" target="_self">Upload Bills</button><br><br><br>
          ...
          <form action="sea1.php" target="_self" method="post">
            ...
            <button id="but" type="submit"><b>Submit</b></button></form>
                ...
                <div class="new1">
                <form  action="bill.php" target="_self" method="post" >
              Medicine Name:&nbsp;<input type="text"  name="name"size="50" onkeypress="return (event.charCode>64 && event.charCode<91) || (event.charCode>96 && event.charCode<122)"required><br><br><br>
